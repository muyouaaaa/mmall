...
public class CartServiceImpl implements ICartService {
    ...
    public ServerResponse<CartVo> add(Integer userId,Integer productId,Integer count){
        ...
        if (productId ==null || count ==null){
            return ServerResponse.createByErrorCodeMessage(ResponseCode.ILLEGAL_AGRUEMENT.getCode(),ResponseCode.ILLEGAL_AGRUEMENT.getDesc());
        }
        ...
        return this.list(userId);  //下面封装好的list()
    }
    ...
    public ServerResponse<CartVo> selectOrUnselect(Integer userId,Integer productId, Integer checked){
        ...
        return this.list(userId);  //上面封装好的list()
    }

    public ServerResponse<Integer> getCartProdcutCount(Integer userId){
        if (userId == null) {
